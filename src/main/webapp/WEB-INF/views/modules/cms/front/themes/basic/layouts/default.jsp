...
<body>
 ...
 <div style="background-image: url(images/index.jpg) ;background-attachment: fixed; background-size: 100%;
  ...
  <%-- <marquee scrollAmount=7 direction="left" scrolldelay="60" style="top: 175px;position:  absolute;">
			<a id="move_id" style="font-size: 20px;color: red;" href="/f/list-300.html?userId=${sessionScope.user.id}"></a>
		</marquee>--%>
	...
	<div class="container">
		...
		<footer>
			...
			<div class="pull-right">${fns:getDate('yyyy年MM月dd日 E')}</div><div class="copyright">		Copyright &copy; 2019-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By ZL ${fns:getConfig('version')}
</div>
      	</footer>
    </div> <!-- /container -->

...
<body>
	<div id="main">
		...
		Copyright &copy; 2018-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By XX ${fns:getConfig('version')} 
			</div>
		</div>
	</div>
	<script type="text/javascript"> 

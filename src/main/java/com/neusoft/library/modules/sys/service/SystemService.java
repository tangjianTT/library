...
import com.neusoft.library.common.security.shiro.session.SessionDAO;
import com.neusoft.library.common.service.BaseService;
import com.neusoft.library.common.service.ServiceException;
...
import com.neusoft.library.common.web.Servlets;
import com.neusoft.library.modules.sys.dao.MenuDao;
import com.neusoft.library.modules.sys.dao.RoleDao;
import com.neusoft.library.modules.sys.dao.UserDao;
...
import com.neusoft.library.modules.sys.security.SystemAuthorizingRealm;
import com.neusoft.library.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public Page<User> findUser(Page<User> page, User user) {
		...
		user.setUserType(user.getCurrentUser().getUserType());
		System.out.println(user.getUserType());
		if(!"3".equals(user.getUserType())){	
			user.setOffice(user.getCurrentUser().getOffice());
		}
		// 执行分页查询
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean validatePassword(String plainPassword, String password) {
		// 明文密码进行加密
		String plain = Encodes.unescapeHtml(plainPassword);
		// 取出该用户存入数据库得密文 取出前八位 是一个数字数组
		byte[] salt = Encodes.decodeHex(password.substring(0,16));
		// 然后进行拼接 按照SHA1生成密文
		byte[] hashPassword = Digests.sha1(plain.getBytes(), salt, HASH_INTERATIONS);
		// 进行验证 数据库得密文和用户输入得密码转换成得密文
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By ZL\r\n");
		sb.append("\r\n======================================================================\r\n");
